...
export const BUSINESS_INFO = {
  ...
  city: 'المنصورة (القاعة الماسية، قاعة مارشال، وقاعات طلخا)',
...
export const INSTAGRAM_POSTS: InstagramPost[] = [
  ...
  },
  {
    ...
    likes: '1,640',
    comments: '73',
    caption: 'تصاميم مخصصة تعكس ذوقك الرفيع بكل دقة وأناقة 👑 تواصلوا معنا عبر إنستغرام',
    tag: '#ديكور_أعراس',
    isVideo: false
  }
];
...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: 't1',
    clientName: 'نورهان السيد',
    eventType: 'حفل زفاف ملكي',
    city: 'المنصورة - القاعة الماسية',
    comment: 'تعامل راقي جداً وتنسيق أكثر من رائع! الكوشة والممشى في القاعة الماسية كانوا خياااال وكل الضيوف انبهروا بالديكور والألوان. تسلم إيدكم على الإتقان والاهتمام بكل التفاصيل الصغيرة.',
    rating: 5,
  ...
  {
    id: 't2',
    clientName: 'ياسمين وأحمد',
    eventType: 'حفل زفاف وكوشة',
    city: 'المنصورة - قاعة مارشال',
    comment: 'تجهيز القاعة وفريق العمل فاق توقعاتي! دخلنا قاعة مارشال والشغل كان يجنن وفخامة لا توصف. صور الكوشة والإضاءة طلعت تحفة في ألبوم العرس. شكراً ديكورا آرت!',
    rating: 5,
    avatarUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&q=80',
    eventDate: 'منذ شهر',
    serviceUsed: 'تنسيق كوشة ومضمار زفاف VIP'
  },
  {
    id: 't3',
    clientName: 'مريم محمود',
    eventType: 'حفلة خطوبة',
    city: 'المنصورة - قاعات طلخا',
    comment: 'التزام بالمواعيد وذوق عالي جداً. القوس والورود والأضواء أعطوا للحفلة طابع مبهج وأنيق جداً. والأسعار مقارنة بالجودة ممتازة.',
    rating: 5,
  ...
  {
    id: 't4',
    clientName: 'داليا إبراهيم',
    eventType: 'تجهيز غرفة العروس',
    city: 'المنصورة - تجهيز روم العروس',
    comment: 'من أفضل من تعاملت معهم، مرونة وسرعة تجاوب وفهموا ذوقي في تجهيز رغبة الديكور وروم العروسة. الديكور كان ناعم وشيك جداً ونفس الصور بالضبط وأجمل على الواقع.',
    rating: 5,
    avatarUrl: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&w=200&q=80',
    eventDate: 'منذ شهرين',
    serviceUsed: 'تنسيق وتجهيز غرفة العروس'
  }
];
...
export const FAQS: FAQItem[] = [
  ...
  {
    id: 'faq3',
    question: 'ما هي المناطق والقاعات التي تغطون خدمات الديكور بها؟',
    answer: 'نغطي المنصورة وضواحيها، ونقدم خدمات التنسيق المتميزة في القاعة الماسية، قاعة مارشال، وقاعات طلخا وكافة القاعات والفنادق، مع فريق تركيب متخصص يحضر بوقت كافٍ قبل بدء المناسبة لضمان الجاهزية التامة.'
  },
  {
    id: 'faq4',
  ...
  },
  {
    ...
    answer: 'يمكنك ملء نموذج الحجز المباشر في الصفحة أو الضغط على زر الإنستجرام للتواصل الفوري عبر الرسائل مع منسقة الديكور وتحديد كافة التفاصيل والحصول على عرض سعر فوري.'
  }
];
